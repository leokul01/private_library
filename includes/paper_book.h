...
class paper_book
{
  ...
  public:
    ...
    */
    paper_book(std::string name, std::string authors,
      int pages_count, std::vector<time_t> read_dates,
    ...
    std::string         get_authors(void) const
    {
      return (authors);
    }
    //! Get number of pages
    ...
    std::vector<time_t> get_read_dates(void) const
    {
      return (read_dates);
    }
